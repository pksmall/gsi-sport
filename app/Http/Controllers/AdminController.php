...
use App\BlogArticle;
use App\BlogArticleGallery;
use App\BlogArticlesTranslation;
use App\BlogCategoriesTranslation;
use App\BlogMultiCategory;
use App\CharacteristicsChildTranslations;
use App\Config;
...
use App\Http\Requests\StoreItemCharacteristicRequest;
use App\Http\Requests\StoreItemTermRequest;
use App\Http\Requests\StoreReviewRequest;
use App\Http\Requests\StoreSettingsRequest;
use App\Http\Requests\StoreSlideRequest;
use App\Http\Requests\StoreStaticPageRequest;
use App\Http\Requests\StoreTableSizeRequest;
use App\Http\Requests\StoreTechnologyCategoryRequest;
use App\Http\Requests\StoreTechnologyRequest;
use App\Image;
use App\Item;
use App\ItemAttribute;
use App\ItemAttributesTranslation;
use App\ItemCategoriesTranslation;
use App\ItemCategory;
use App\ItemCharacteristic;
use App\ItemCharacteristicsTranslation;
use App\ItemGallery;
use App\RecommendedItem;
use App\ItemMultiCategory;
use App\ItemTableSize;
use App\ItemTechnology;
use App\ItemTerms;
use App\ItemTranslation;
use App\Order;
use App\OrderItem;
use App\Repositories\AttributeTermsRepositoryInterface;
use App\Repositories\BlogArticlesRepositoryInterface;
use App\Repositories\BlogCategoriesRepositoryInterface;
use App\Repositories\ClientActivityRepositoryInterface;
use App\Repositories\ItemCategoriesRepositoryInterface;
use App\Repositories\ItemAttributesRepositoryInterface;
use App\Repositories\ItemCharacteristicsRepositoryInterface;
 ...
 * @property OrdersRepositoryInterface orders
 * @property ItemCategoriesRepositoryInterface item_categories
 * @property ReviewsRepositoryInterface reviews
 * @property BlogCategoriesRepositoryInterface blog_categories
 * @property BlogArticlesRepositoryInterface blog_articles
 * @property ClientActivityRepositoryInterface client_activity
 * @property ItemAttributesRepositoryInterface item_attributes
 * @property AttributeTermsRepositoryInterface attribute_terms
 * @property ItemCharacteristicsRepositoryInterface item_characteristics
 */
class AdminController extends Controller
{
    ...
    public function __construct(
        ...
        AttributeTermsRepositoryInterface           $attributeTermsRepository,
        ItemCharacteristicsRepositoryInterface      $itemCharacteristicsRepository,
        ReviewsRepositoryInterface                  $reviewsRepository,
        UsersRepositoryInterface                    $usersRepository,
        OrdersRepositoryInterface                   $ordersRepository,
        BlogCategoriesRepositoryInterface           $blogCategoriesRepository,
        BlogArticlesRepositoryInterface             $blogArticlesRepository,
        ClientActivityRepositoryInterface           $clientActivityRepository
    )
    {
        $this->items = $itemsRepository;
        $this->item_categories = $itemCategoriesRepository;
        $this->item_attributes = $itemAttributesRepository;
        $this->attribute_terms = $attributeTermsRepository;
        $this->item_characteristics = $itemCharacteristicsRepository;
        $this->reviews = $reviewsRepository;
        $this->users = $usersRepository;
        $this->orders = $ordersRepository;
        $this->blog_categories = $blogCategoriesRepository;
        $this->blog_articles = $blogArticlesRepository;
        $this->client_activity = $clientActivityRepository;
    ...
    {
        $stats = [
            'sales' => $this->orders->findWithParams(['status_id' => 1])->count(),
