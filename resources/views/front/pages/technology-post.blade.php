...
@section('content')
            ...
            <div class="technology-article-body content-wrapper">
                ...
                <div class="technology-article-slider-content">
                    ...
                    <div id="technology-article-slider" class="carousel slide" data-ride="carousel">
                        @if(isset($post->item->gallery) && $post->item->gallery != null)
                            <div class="carousel-inner">
                                <?php $index = 0; ?>
                                @foreach($post->item->gallery as $gallery)
                        ...
                        @endif
                        @if(isset($post->item->gallery) && count($post->item->gallery) < 1 && isset($post->item->preview) && $post->item->preview != null)
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset($post->item->preview->path) }}" alt="First slide">
                                </div>
                            </div>
                        @endif
                            @if(isset($post->item->gallery) && count($post->item->gallery) < 1 && !isset($post->item->preview) && $post->item->preview == null)
                            ...
                            @endif
                        @if(isset($post->item->gallery) && $post->item->gallery != null && $post->item->gallery->count() > 1)
                    ...
                    <div class="technology-article-links">
                        <p>
                            {{ $post->item->created_at->format('m.d.Y') }}
    ...
    @if(isset($post->item->recommended_items) && $post->item->recommended_items->count() > 0)
        <section id="product-extra" class="product-extra">
            ...
            <div class="container-pages">
                ...
                <div class="content-wrapper">
                    @foreach($post->item->recommended_items as $recommended_item)
